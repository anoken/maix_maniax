...
yolo_loss = YoloLoss(GRID,CLASS,ANCHORS,COORD_SCALE,CLASS_SCALE,
...
converter = tf.lite.TFLiteConverter.from_keras_model_file("my_yolo.h5",
output_arrays=[output_layer])tflite_model = converter.convert()
